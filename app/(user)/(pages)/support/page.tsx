...
export default function SupportPage() {
    ...
    return (
        <div className='flex min-h-screen bg-white xs:bg-[#FFFFF0] no-scrollbar'>
            ...
            <div className='flex-1 p-6 lg:p-10 xs:px-4 xs:pt-4 xs:pb-24 overflow-x-hidden no-scrollbar'>
                <div className='max-w-[900px]'>
                    ...
                    <div className='hidden xs:flex items-center gap-3 mb-4'>
                        ...
                        <h1 className='font-poppins typo-heading-md-semibold text-text_one'>Help & Support</h1>
                    </div>
                    {/* Header */}
