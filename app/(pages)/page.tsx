    ...
    try {
        return (
            <div className='flex-1 grid grid-cols-2 xs:grid-cols-1 w-full xs:grid-sizes'>
                <div className='w-[454px] xs:w-full mx-auto my-auto'>
                    <div className='typo-heading_small_bold text-primary fixed top-[47px] flex w-full xs:inset-0 xs:mt-[46px] xs:justify-center'>
                        Flipit
                    </div>
                    <Form />
                </div>
