    ...
    return (
        <div className='grid-sizes grid grid-cols-[712px_1fr] xs:grid-cols-1 gap-6 h-full mt-10 xs:mb-6'>
            ...
            <div className='p-6 xs:p-0'>
                ...
                <p className='typo-heading_small_medium text-primary xs:typo-body_medium_medium xs:mb-1'>₦1,300,000</p>
                ...
                <div className='flex items-center justify-between'>
                    ...
                    <span className='typo-body_medium_regular text-primary underline'>View Seller Details</span>
                </div>
