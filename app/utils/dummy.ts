...
export const dummyItems: any[] = [
    {
        ...
        imageUrls: ['/icons/action/camera.png'],
        flipForImgUrls: ['/icons/action/camera.png'],
        acceptCash: true,
        cashAmount: 480000,
        condition: 'used',
        published: true,
        ...
        seller: {
            ...
            avatar: '/images/placeholders/profile-picture.svg',
            avg_rating: 4.7,
            status: 'Verified',
    ...
    buyer: [
        {
            ...
            initiatorAvatar: '/images/placeholders/profile-picture.svg',
            receiverAvatar: '/images/placeholders/profile-picture.svg',
